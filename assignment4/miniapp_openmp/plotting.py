...
assert data.shape[0] == res_x * \
    res_y, "raw data array does not match the resolution in the header"
...
C = pl.contour(X, Y, data.reshape(res_y, res_x),
               N, colors='black', linewidth=.1)
